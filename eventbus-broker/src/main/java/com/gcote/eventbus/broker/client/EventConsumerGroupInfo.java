...
public class EventConsumerGroupInfo extends ConsumerGroupInfo {
    ...
    public EventConsumerGroupInfo(String groupName, ConsumeType consumeType, MessageModel messageModel,
