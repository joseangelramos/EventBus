...
import com.gcote.eventbus.broker.EventBrokerPathConfigHelper;
...
public class MessageRedirectManager {
    ...
    public MessageRedirectManager(EventBrokerController eventBrokerController) {
        ...
        if (flag != null) {
            ...
            if (flagMap != null) {
                ...
                if (confItems != null) {
                    ...
                    HashMap<Integer/*queueId*/, String/*clientId*/> cidMap = eventBrokerController.getClientRebalanceResultManager().getTopicListenMap(groupName, topic);
    ...
    public class RedirectConfigManager extends ConfigManager {
        ...
        @Override public String configFilePath() {
            String rootDir = EventBrokerPathConfigHelper.getBrokerConfigPath();
