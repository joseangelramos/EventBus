...
public class EventConsumerManager extends ConsumerManager {
    ...
    public EventConsumerManager(final ConsumerIdsChangeListener consumerIdsChangeListener,
        ...
        try {
            ...
            log.warn("init EventConsumerManager err.", ex);
        }
    }
    ...
    public boolean registerConsumer(final String group, final ClientChannelInfo clientChannelInfo,
        ...
        if (null == consumerGroupInfo) {
            ConsumerGroupInfo tmp = new EventConsumerGroupInfo(group, consumeType, messageModel, consumeFromWhere);
            ConsumerGroupInfo prev = this.consumerTable.putIfAbsent(group, tmp);
            consumerGroupInfo = prev != null ? prev : tmp;
        }
        EventConsumerGroupInfo eventConsumerGroupInfo = (EventConsumerGroupInfo) consumerGroupInfo;

        Set<String> oldSub = eventConsumerGroupInfo.findSubscribedTopicByClientId(clientChannelInfo.getClientId());
        ...
        boolean r2 = eventConsumerGroupInfo.registerClientId(subList, clientChannelInfo.getClientId());
    ...
    public void unregisterConsumer(final String group, final ClientChannelInfo clientChannelInfo,
        ...
        if (null != consumerGroupInfo) {
            EventConsumerGroupInfo eventConsumerGroupInfo = (EventConsumerGroupInfo) consumerGroupInfo;
            subscribeTopics = eventConsumerGroupInfo.unregisterClientId(clientChannelInfo);
        }
    ...
    public void doChannelCloseEvent(final String remoteAddr, final Channel channel) {
        ...
        while (it.hasNext()) {
            ...
            if (info.getChannelInfoTable().get(channel) != null) {
                ...
                EventConsumerGroupInfo eventConsumerGroupInfo = (EventConsumerGroupInfo) info;
                subscribeTopics = eventConsumerGroupInfo.findSubscribedTopicByClientId(clientChannelInfo.getClientId());
            }
        }
    ...
    public void scanNotActiveChannel() {
        ...
        while (it.hasNext()) {
            ...
            EventConsumerGroupInfo consumerGroupInfo = (EventConsumerGroupInfo) next.getValue();
