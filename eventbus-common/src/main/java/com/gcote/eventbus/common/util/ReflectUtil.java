...
import com.gcote.eventbus.common.exception.EventBusRuntimeException;
...
public class ReflectUtil {
    public static void setSimpleProperty(Class<?> c, Object instance, String proName, Object value) {
        try {
            ...
            throw new EventBusRuntimeException("set property fail", e);
    ...
    public static Object getSimpleProperty(Class<?> c, Object instance, String proName) {
        ...
        try {
            ...
            throw new EventBusRuntimeException("get property fail", e);
        } catch (IllegalAccessException e) {
            throw new EventBusRuntimeException("get property fail", e);
        } catch (Exception e) {
            throw new EventBusRuntimeException("get property fail", e);
    ...
    public static void invokeMethod(Class<?> c, Object instance, String methodName) {
        try {
            ...
            throw new EventBusRuntimeException("invokeMethod fail", e);
    ...
    public static void invokeMethodByParams(Method method, Object instance, Object... params) {
        try {
            ...
            throw new EventBusRuntimeException("invokeMethodByParams fail", e);
        } catch (InvocationTargetException e) {
            throw new EventBusRuntimeException("invokeMethodByParams fail", e);
        } catch (Exception e) {
            throw new EventBusRuntimeException("invokeMethodByParams fail", e);
    ...
    public static Method getMethodByName(Class c, String methodName) {
        try {
            ...
            throw new EventBusRuntimeException("getMethodByName fail", e);
        } catch (Exception e) {
            throw new EventBusRuntimeException("getMethodByName fail", e);
        }
        return null;
