...
public class EventBusTopicConfig {
    public static final long DEFAULT_QUEUE_LENGTH = 500;
    private static final String SEPARATOR = " ";
    private String topicName;
    private long maxQueueDepth = DEFAULT_QUEUE_LENGTH;

    public EventBusTopicConfig() {
    }

    public EventBusTopicConfig(String topicName) {
        this(topicName, DEFAULT_QUEUE_LENGTH);
    }

    public EventBusTopicConfig(String topicName, long maxQueueDepth) {
    ...
    public boolean equals(final Object o) {
        ...
        final EventBusTopicConfig that = (EventBusTopicConfig) o;
