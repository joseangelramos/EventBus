...
package com.gcote.eventbus.client.impl;

import com.gcote.eventbus.common.EventBusConstant;
import com.gcote.eventbus.common.protocol.EventBusRequestCode;
import com.gcote.eventbus.common.protocol.body.GetConsumerListByGroupAndTopicResponseBody;
...
public class EventBusClientAPIImpl extends MQClientAPIImpl {
    public static final Logger LOGGER = LoggerFactory.getLogger(EventBusClientAPIImpl.class);
    private static boolean sendSmartMsg =
        Boolean.parseBoolean(System.getProperty("org.apache.rocketmq.client.sendSmartMsg", "true"));
    private TopAddressing topAddressing;

    public EventBusClientAPIImpl(NettyClientConfig nettyClientConfig,
    ...
    public SendResult sendMessage(//
        ...
        if (EventBusConstant.REPLY.equals(msg.getProperties().get(EventBusConstant.KEY)) ||
                EventBusConstant.DIRECT.equals(msg.getProperties().get(EventBusConstant.KEY))) {
            if (sendSmartMsg) {
                SendMessageRequestHeaderV2 requestHeaderV2 = SendMessageRequestHeaderV2.createSendMessageRequestHeaderV2(requestHeader);
                request = RemotingCommand.createRequestCommand(EventBusRequestCode.SEND_DIRECT_MESSAGE_V2, requestHeaderV2);
            } else {
                request = RemotingCommand.createRequestCommand(EventBusRequestCode.SEND_DIRECT_MESSAGE, requestHeader);
            }
    ...
    public List<String> getConsumerIdListByGroupAndTopic(
        ...
        RemotingCommand request = RemotingCommand.createRequestCommand(EventBusRequestCode.GET_CONSUMER_LIST_BY_GROUP_AND_TOPIC, requestHeader);
