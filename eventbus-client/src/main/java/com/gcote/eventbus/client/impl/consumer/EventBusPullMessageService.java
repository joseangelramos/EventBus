...
package com.gcote.eventbus.client.impl.consumer;
...
public class EventBusPullMessageService extends PullMessageService {
    ...
    private final ExecutorService executorService = Executors.newSingleThreadExecutor(
        new ThreadFactory() {
            ...
            public Thread newThread(Runnable r) {
                return new Thread(r, "EventBusPullMessageRetryThread");
            }
        });

    public EventBusPullMessageService(EventBusClientInstance eventBusClientInstance) {
        super(eventBusClientInstance);
        this.mQClientFactory = eventBusClientInstance;
    ...
    public String getServiceName() {
        return EventBusPullMessageService.class.getSimpleName();
    }
